    ...
    <main className="max-w-6xl mx-auto px-4 py-12">
      ...
      {auctions.length === 0 ? (
        <div className="text-center py-20 bg-gray-50 rounded-2xl border border-gray-100">
          ...
          <h2 className="text-lg font-semibold text-gray-500 mb-2">No active auctions</h2>
          <p className="text-gray-400 text-sm mb-6">Check back later or list the first item yourself!</p>
          {user && (
            <Link
              href="/auctions/create"
